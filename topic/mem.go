...
func (m *memManager) Subscribe(sub Subscription) (byte, error) {
	if !validQos(sub.Qos) {
		return qosFail, fmt.Errorf("Invalid QoS %d", qos)
	}
	...
	if err := m.sroot.sinsert(topic, qos, sub); err != nil {
...
func (this *memManager) Unsubscribe(topic []byte, sub interface{}) error {
	this.smu.Lock()
...
func (this *memManager) Retain(msg *packets.PublishPacket) error {
	this.rmu.Lock()
...
func (this *memManager) Retained(topic []byte, msgs *[]*packets.PublishPacket) error {
	this.rmu.RLock()
...
func (this *memManager) Close() error {
	this.sroot = nil
	this.rroot = nil
	return nil
}
